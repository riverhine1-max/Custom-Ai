/**
 * Ludomuse's model sizes. Plain data, safe to import anywhere.
...
export const UNSUPPORTED_MESSAGE =
  "This browser can't run Ludomuse, the free AI. It needs WebGPU: use the latest Chrome or Edge on a computer, or Safari on a Mac with macOS 26. " +
