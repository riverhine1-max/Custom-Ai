...
export const Icons = {
  ...
  dice: icon(["M5 4h14a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1z", "M8.5 8.5h.01", "M15.5 8.5h.01", "M12 12h.01", "M8.5 15.5h.01", "M15.5 15.5h.01"]),
  download: icon(["M12 4v11", "M7 10l5 5 5-5", "M5 20h14"]),
};

/** The app's mark (same drawing as the app icon), for the sidebar and splash. */
export function AppMark({ size = 30 }: { size?: number }) {
  return (
    <svg className="app-mark" width={size} height={size} viewBox="0 0 512 512" aria-hidden="true">
      <defs>
        <linearGradient id="am-bg" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stopColor="#23664a" /><stop offset="1" stopColor="#0b2118" /></linearGradient>
      </defs>
      <rect width="512" height="512" rx="112" fill="url(#am-bg)" />
      <path d="M256 112 L385.9 187 L385.9 337 L256 412 L126.1 337 L126.1 187 Z" fill="none" stroke="#f3eee4" strokeWidth="26" strokeLinejoin="round" />
      <path d="M256 170 L343 322 L169 322 Z" fill="none" stroke="#f3eee4" strokeOpacity=".5" strokeWidth="13" strokeLinejoin="round" />
      <path d="M256 208 C261 247 274 259 312 266 C274 273 261 285 256 324 C251 285 238 273 200 266 C238 259 251 247 256 208 Z" fill="#e9c37c" />
    </svg>
  );
}
